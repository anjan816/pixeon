            ...
            {isFree && currentProjectCount >= 99 && (
              <Alert className="bg-amber-500/10 border-amber-500/20">
                ...
                <AlertDescription className="text-amber-300/80">
                  ...
                  {currentProjectCount === 99
                    ? "This will be your last free project. Upgrade to Pixeon Pro for unlimited projects."
                    : "Free plan is limited to 100 projects. Upgrade to Pixeon Pro to create more projects."}
                </AlertDescription>
              </Alert>
            )}
